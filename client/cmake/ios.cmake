...
set_target_properties(${PROJECT} PROPERTIES
    ...
    MACOSX_BUNDLE_INFO_STRING "Sotka"
    MACOSX_BUNDLE_BUNDLE_NAME "Sotka"
    ...
    XCODE_ATTRIBUTE_PRODUCT_NAME "Sotka"
    XCODE_ATTRIBUTE_BUNDLE_INFO_STRING "Sotka"
...
if(DEFINED DEPLOY)
    set_target_properties(${PROJECT} PROPERTIES
        ...
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER "distr ios.org.amnezia.VPNNaruzhu"
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER[variant=Debug] "dev ios.org.amnezia.VPNNaruzhu"
    )
else()
    set_target_properties(${PROJECT} PROPERTIES
...
target_sources(${PROJECT} PRIVATE
    ${CMAKE_CURRENT_SOURCE_DIR}/ios/app/SotkaLaunchScreen.storyboard
