...
QJsonObject ServersController::naruzhuGetDefaultAccount(void) const
{
    return m_serversRepository->naruzhuGetDefaultAccount();
}

void ServersController::naruzhuRemoveDefaultAccount(void) const
{
    return m_serversRepository->naruzhuRemoveDefaultAccount();
}

bool ServersController::naruzhuIsThereDefaultAccount(void) const
{
    return m_serversRepository->naruzhuIsThereDefaultAccount();
}