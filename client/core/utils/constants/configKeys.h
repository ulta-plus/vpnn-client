...
namespace amnezia
{
    namespace configKey
    {
        ...
        constexpr QLatin1String is_default("is_default");
        constexpr QLatin1String email("email");
        constexpr QLatin1String public_request_id("public_request_id");
        constexpr QLatin1String payment_link("payment_link");
        constexpr QLatin1String paid_until("paid_until");
        constexpr QLatin1String simplified_status("simplified_status");
    }
}
