...
void Migrations::migrateV3()
{
    ...
    QString location = rootLocation + "/files/.config/Sotka.ORG/Sotka.conf";
    ...
    if (oldConfig.exists()) {
        ...
        QFile newConfigFile(newConfigPath + "/Sotka.conf");
