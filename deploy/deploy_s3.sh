...
wget -q https://github.com/ulta-plus/vpnn-client/releases/download/${VERSION}/Sotka_${VERSION}_android8+_arm64-v8a.apk
wget -q https://github.com/ulta-plus/vpnn-client/releases/download/${VERSION}/Sotka_${VERSION}_android8+_armeabi-v7a.apk
wget -q https://github.com/ulta-plus/vpnn-client/releases/download/${VERSION}/Sotka_${VERSION}_android8+_x86.apk
wget -q https://github.com/ulta-plus/vpnn-client/releases/download/${VERSION}/Sotka_${VERSION}_android8+_x86_64.apk
wget -q https://github.com/ulta-plus/vpnn-client/releases/download/${VERSION}/Sotka_${VERSION}_android_7_arm64-v8a.apk
