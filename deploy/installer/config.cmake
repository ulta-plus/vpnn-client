...
elseif(LINUX)
    ...
    configure_file(
        ...
        ${CMAKE_BINARY_DIR}/../AppDir/Sotka.desktop
    )
endif()

configure_file(
    ${CMAKE_CURRENT_LIST_DIR}/packages/org.sotka.package/meta/package.xml.in
    ${CMAKE_BINARY_DIR}/installer/packages/org.sotka.package/meta/package.xml
)
